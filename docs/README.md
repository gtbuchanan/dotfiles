...
| [`ssh.md`](ssh.md)                   | Shared `Include ./*.conf` config, private host inventory repo, Windows-native OpenSSH as the canonical client, WSL→Windows agent bridge, Android popup askpass                               |
